...
<ShellLessonTrigger case-id="task-05" label="载入任务 05：函数与作用域" />
<ShellLessonTrigger case-id="task-06" label="载入任务 06：管道与文件" />
<ShellLessonTrigger case-id="pitfall-fish-pipeline" label="载入 Fish 管道作用域坑位" />

<ShellLessonLab :case-ids="['task-05', 'task-06', 'pitfall-fish-pipeline']" default-variant="bash" />
