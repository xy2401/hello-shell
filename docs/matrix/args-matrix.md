...
延伸阅读：[bash 入参](/products/bash/args)、[zsh 入参](/products/zsh/args)、[fish 入参](/products/fish/args)、[cmd 入参](/products/cmd/args)、[PowerShell 入参](/products/powershell/args)、[统一入参骨架](/concepts/)。
