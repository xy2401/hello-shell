...
选择任一统一任务载入下方实验区，再切换运行体查看执行能力与仓库快照。轻量运行体在本页执行，真实 Shell 案例会转到完整工作台。

<ShellLessonTrigger case-id="task-00" label="载入任务 00" />
<ShellLessonTrigger case-id="task-01" label="载入任务 01" />
<ShellLessonTrigger case-id="task-02" label="载入任务 02" />
<ShellLessonTrigger case-id="task-03" label="载入任务 03" />
<ShellLessonTrigger case-id="task-04" label="载入任务 04" />
<ShellLessonTrigger case-id="task-05" label="载入任务 05" />
<ShellLessonTrigger case-id="task-06" label="载入任务 06" />
<ShellLessonTrigger case-id="task-07" label="载入任务 07" />
<ShellLessonTrigger case-id="task-08" label="载入任务 08" />

<ShellLessonLab :case-ids="['task-00', 'task-01', 'task-02', 'task-03', 'task-04', 'task-05', 'task-06', 'task-07', 'task-08']" default-variant="bash" />
