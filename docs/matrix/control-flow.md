...
- [统一任务实验总览 · 任务 04](/matrix/experiments#任务-04-控制流)
...
<ShellLessonTrigger case-id="task-04" label="载入任务 04：控制流" />
<ShellLessonTrigger case-id="pitfall-fish-pipeline" label="载入 Fish 管道作用域坑位" />

<ShellLessonLab :case-ids="['task-04', 'pitfall-fish-pipeline']" default-variant="bash" />
