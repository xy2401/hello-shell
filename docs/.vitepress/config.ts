      ...
      '/playground/': [
        {
          ...
          items: [
            ...
            { text: 'c2w (Base/综合)', link: '/playground/container2wasm' },
            { text: 'c2w (Shell精简版)', link: '/playground/c2w-shell' },
            { text: 'c2w (Shell+Nu全能版)', link: '/playground/c2w-shell-x64' },
            { text: 'c2w (Python 3)', link: '/playground/c2w-python' },
